...
def generate_threat_severity_data(num_samples=1000):
    data = {
        ...
        "Threat Detected": np.random.randint(0, 2, num_samples)
    }
...
synthetic_data.to_csv('data/historical_data.csv', index=False)
print(f"Synthetic data with {num_samples} samples saved to 'data/historical_data.csv'")
